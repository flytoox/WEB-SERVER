...
if (isset($_COOKIE['username']) && isset($_COOKIE['loggedIn'])) {
    ...
    <head>
        ...
        <link rel="stylesheet" href="/WebServ/pages/styles.css">
    </head>
    <body>
        <div class="header">
            <ul class="headerLinks">
                <li class="headerItem" ><a href="/">Root</a></li>
                <li class="headerItem" ><a href="/WebServ/pages/html/upload.html">Upload</a></li>
                <li class="headerItem" ><a href="/WebServ/cgiTests/php/example.php">Get</a></li>
                <li class="headerItem" ><a href="/WebServ/pages/html/post.html">Post</a></li>
        ...
        <div class="container">
            <div class="head">
                ...
                <a class="basicLink" href="/WebServ/cgiTests/php/logout.php">Logout</a>
            </div>
        </div>
    </body>
    </html>
